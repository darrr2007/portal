...
const Portal = () => {
      return (
        ...
        <b className="all-rights-reserved"> Streak Tech | All rights reserved | 2023 </b>
        <div className="contentwrap">
          ...
          <div className="contentwrap1">
            ...
            <div className="guide-butt">
              ...
              <div className="content">
                <div className="nfo-content">6th grade <br/> Guidebook</div>
            ...
            <div className="guide-butt1">
              ...
              <div className="content">
                <div className="nfo-content">6th grade <br/> Workbook</div>
                <button className="button">
                    <b className="sml-txt"> <Link to="/PdfPreview">View</Link></b>
          ...
          <Routes>
            <Route exact path="/PdfPreview" element={<PdfPreview />} />
          </Routes>
        </div>
